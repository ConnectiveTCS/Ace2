<x-app-layout>
    ...
    <!-- Projects Section -->
    <section class="mt-16 bg-gray-100 dark:bg-gray-900  md:p-3 md:px-32">
    ...
    <section id="services"
        ...
        <div
            ...
            <p class="w-[50%] text-center place-self-center text-gray-700 dark:text-gray-300">
