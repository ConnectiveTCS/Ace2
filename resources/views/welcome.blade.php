<x-app-layout>
        ...
        <div
            ...
            <div
                ...
                <p class="mt-4 text-lg leading-6 text-gray-700 dark:text-gray-300">
                    We merge creativity with technical excellence to build websites that drive business growth.
                </p>
    ...
    <section id="hero" class="bg-gray-100 dark:bg-gray-900 md:max-h-[90vh] flex items-center justify-center md:p-3">
        <div class="mx-auto py-16 px-4 sm:px-6 lg:px-8 md:w-full md:h-full">
            <div
                class=" my-auto text-center text-gray-700 h-full dark:text-gray-300 grid grid-cols-1 md:grid-cols-3 gap-4">
                <h2
                    ...
                    strategic
                    thinking with a keen eye for detail, ensuring that every project tells your unique story.
                </h2>
    ...
    <section id="services" class="bg-gray-100 dark:bg-gray-900 md:max-h-[90vh] flex items-center justify-center md:p-3">
        <div
            class="mx-auto py-16 px-4 sm:px-6 lg:px-8 rounded-lg shadow-lg bg-white dark:bg-gray-800 md:w-full md:h-full">
            <h2 class="text-3xl font-extrabold text-gray-900 dark:text-gray-100 text-center">Our Services</h2>
            <p class="w-[50%] text-center place-self-center text-gray-700 dark:text-gray-300">From custom web design and responsive development to seamless user experience enhancements, we offer a
            ...
            <div class="mt-12 grid
                ...
                <div class="card-3d bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                    ...
                    <p class="mt-4 text-gray-700 dark:text-gray-300">
                        ...
                        efficiency, and drive growth. Our SaaS development services are designed to meet the unique needs
                        of your business.
                    </p>
                </div>
                <div class="card-3d bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
